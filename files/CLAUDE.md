...
## Core Feature Rules
1. **Vocab Folder Deck Stacking Cards**:
   - Cards stack over each other as the user scrolls up (`sticky top-[...]`), creating an authentic physical folder index card stack effect.
...
4. **Radial Capture Gesture**: Single-stage capture gesture (Notes, Lists, Vocab, Calendar).
   - Direct click = browse section view.
   - Drag & drop = create new entry immediately.
5. **Deletion**: Immediate permanent delete, no trash bin.
