...
export const ListsView: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-6 flex flex-col h-full overflow-hidden">
      {/* Static Subheader Title (Lists scroll below this, never behind or under the title) */}
      <div className="flex items-center gap-3 border-b border-white/10 pt-3 pb-4 flex-shrink-0 z-10 bg-transparent">
        <button
      ...
      {/* Lists Grid Container — Scrolls strictly below the title header */}
