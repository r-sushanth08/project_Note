...
export const VocabView: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-6 flex flex-col h-full overflow-hidden">
      {/* Static Subheader Title (Cards scroll below this, never behind or under the title) */}
      <div className="flex items-center justify-between border-b border-white/10 pt-3 pb-4 flex-shrink-0 z-10 bg-transparent">
      ...
      {/* Cards Deck Container — Scrolls strictly below the title header */}
