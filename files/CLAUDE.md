...
2. **Vocab Folder Deck Stacking Cards**:
...
5. **Radial Capture Gesture**: Single-stage capture gesture (Notes, Lists, Vocab, Calendar).
   - Direct click = browse section view.
   - Drag & drop = create new entry immediately.
6. **Deletion**: Immediate permanent delete, no trash bin.
